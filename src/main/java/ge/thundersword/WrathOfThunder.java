...
public class WrathOfThunder extends JavaPlugin implements Listener {
    ...
    // ── every 4th hit with the sword → lightning ──
    @EventHandler
    ...
    // ── wielder is immune to their own lightning ──
    ...
    private void playKillAnimation(Location loc, Player killer) {
        ...
        loc.getWorld().spawnParticle(Particle.LARGE_SMOKE,       loc, 3,  0.3, 0.3, 0.3, 0.05);
        ...
        loc.getWorld().spawnParticle(Particle.WITCH,             loc, 40, 0.4, 0.8, 0.4, 0.5);
        ...
        new BukkitRunnable() {
            ...
            @Override public void run() {
                ...
                loc.getWorld().spawnParticle(Particle.ENCHANTED_HIT, ring, 4, 0.2, 0.2, 0.2, 0.1);
                tick++;
            }
    ...
    private void spawnHitEffect(Location loc) {
        ...
        loc.getWorld().spawnParticle(Particle.WITCH, loc, 20, 0.3, 0.5, 0.3, 0.3);
